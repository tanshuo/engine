...
{
    TC_ID mid = [super InitialWithName:name WithX:x WithY:y WithZ:z WithHeight:height WithWidth:width WithScript:script WithShader:shader WithTexture:nil WithGroup:group];
    _anims = frames;
    return mid;
}
- (void) drawSelf
